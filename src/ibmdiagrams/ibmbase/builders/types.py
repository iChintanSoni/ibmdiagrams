...
from ..utils.constants import ShapeKind, ShapeStyle, StaticShapeStyle
...
class Types:
    ...
    def buildLink(self, id, label, source, target, startarrow, endarrow, startfill, endfill, linetype, linewidth, linecolor, fontname, fontsize, meta):
        ...
        style += 'strokeWidth=' + \
            str(linewidth) + ';fontFamily=' + fontname + \
        ...
        if linetype.upper() == "DOUBLE":
            ...
            if startarrow == "":
                ...
                style += 'startArrow=' + startarrow + \
                    ';startFill=' + ('1' if startfill else '0') + ';'
                if startarrow == "oval":
            ...
            if endarrow == "":
                ...
                style += 'endArrow=' + endarrow + ';endFill=' + \
                    ('1' if endfill else '0') + ';'
                if endarrow == "oval":
                    # Note: Default is for oval to be centered on border so add space to be next to border per design center.
    ...
    def buildShape(self, id, node, x, y, width, height, meta, genflag):
        ...
        data = {'header': header, 'cell': cell,
                'geo': geo, 'props':  props, 'point': {}}
    ...
    def buildDrawioShape(self, id, node, x, y, width, height, meta, genflag):
        ...
        if shape == "actor":
            data = self.buildActorShape(
                id, node, x, y, width, height, meta, shapelabel)
        elif shape == "pnode":
            data = self.buildPNodeShape(
                id, node, x, y, width, height, meta, shapelabel)
        elif shape == "epnode":
            data = self.buildEPNodeShape(
                id, node, x, y, width, height, meta, shapelabel)
        elif shape == "ploc":
            data = self.buildPLocShape(
                id, node, x, y, width, height, meta, shapelabel)
        # elif shape == "gploc":
        #   data = self.buildGPLocShape( id, node, x, y, width, height, meta, shapelabel)
        elif shape == "zone":
            data = self.buildZoneShape(
                id, node, x, y, width, height, meta, shapelabel)
        # elif shape == "gzone":
    ...
    def buildActorShape(self, id, node, x, y, width, height, meta, shapelabel):
        ...
        icon = node["icon"]
        styleicon = "shape=mxgraph.ibm_cloud." + icon + \
            ";fillColor=#ffffff;strokeColor=none;dashed=0;outlineConnect=0;part=1;movable=0;resizable=0;rotatable=0;"
    ...
    def buildEPNodeShape(self, id, node, x, y, width, height, meta, shapelabel):
        ...
        styleshape = "container=1;collapsible=0;expand=0;recursiveResize=0;image=;strokeColor=" + \
        ...
        stylelabel = "shape=rect;strokeColor=none;fillColor=" + linecolor + \
        ...
        icon = node["icon"]
        styleicon = "shape=mxgraph.ibm_cloud." + icon + \
            ";fillColor=#ffffff;strokeColor=none;dashed=0;outlineConnect=0;html=1;labelPosition=center;verticalLabelPosition=bottom;verticalAlign=top;part=1;movable=0;resizable=0;rotatable=0;"
    ...
    def buildPLocShape(self, id, node, x, y, width, height, meta, shapelabel):
        ...
        linecolor = node["linecolor"]
        styleshape = "container=1;collapsible=0;expand=0;recursiveResize=0;image=;strokeColor=" + \
            linecolor + ";fillColor=" + fillcolor + ";strokeWidth=1;"
        ...
        icon = node["icon"]
        styleicon = "shape=mxgraph.ibm_cloud." + icon + ";strokeColor=none;fillColor=" + linecolor + \
            ";aspect=fixed;resizable=0;rotatable=0;labelPosition=right;verticalLabelPosition=middle;align=left;verticalAlign=middle;part=1;dashed=0;outlineConnect=0;spacingLeft=5;"
        ...
        stylesidebar = "shape=rect;strokeColor=none;fillColor=" + \
            linecolor + ";aspect=fixed;resizable=0;part=1;spacingLeft=5;"
    ...
    def buildZoneShape(self, id, node, x, y, width, height, meta, shapelabel):
        ...
        if fillcolor == "":
            fillcolor = "none"
        linecolor = node["linecolor"]
        styleshape = "container=0;collapsible=0;expand=0;recursiveResize=0;image=;strokeColor=" + \
            linecolor + ";fillColor=" + fillcolor + \
        ...
        icon = node["icon"]
        styleicon = "shape=mxgraph.ibm_cloud." + icon + ";fillColor=" + linecolor + \
            ";strokeColor=none;dashed=0;outlineConnect=0;part=1;movable=0;resizable=0;rotatable=0;"
