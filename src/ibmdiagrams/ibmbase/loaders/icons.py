...
class Icons:
    ...
    def addRegions(self):
        data = [
            {'label': 'Sydney',        'id': 'au-syd',
                'IBM Cloud Group': 'IBM Cloud Group'},
            {'label': 'Sao Paulo',     'id': 'br-sao',
                'IBM Cloud Group': 'IBM Cloud Group'},
            {'label': 'Toronto',       'id': 'ca-tor',
                'IBM Cloud Group': 'IBM Cloud Group'},
            {'label': 'Frankfurt',     'id': 'eu-de',
                'IBM Cloud Group': 'IBM Cloud Group'},
            {'label': 'London',        'id': 'eu-gb',
                'IBM Cloud Group': 'IBM Cloud Group'},
            {'label': 'Osaka',         'id': 'jp-osa',
                'IBM Cloud Group': 'IBM Cloud Group'},
            {'label': 'Tokyo',         'id': 'jp-tok',
                'IBM Cloud Group': 'IBM Cloud Group'},
            {'label': 'Washington DC', 'id': 'us-east',
                'IBM Cloud Group': 'IBM Cloud Group'},
            {'label': 'Dallas',        'id': 'us-south',
                'IBM Cloud Group': 'IBM Cloud Group'}
        ]
    ...
    def addCloudServices(self):
        data = [
            {'label': 'Cloud Services', 'id': 'servicesau-syd',
                'Region Group': 'au-syd',   'Cloud Services Group': 'Cloud Services Group'},
            {'label': 'Cloud Services', 'id': 'servicesbr-sao',
                'Region Group': 'br-sao',   'Cloud Services Group': 'Cloud Services Group'},
            {'label': 'Cloud Services', 'id': 'servicesca-tor',
                'Region Group': 'ca-tor',   'Cloud Services Group': 'Cloud Services Group'},
            {'label': 'Cloud Services', 'id': 'serviceseu-de',
                'Region Group': 'eu-de',    'Cloud Services Group': 'Cloud Services Group'},
            {'label': 'Cloud Services', 'id': 'serviceseu-gb',
                'Region Group': 'eu-gb',    'Cloud Services Group': 'Cloud Services Group'},
            {'label': 'Cloud Services', 'id': 'servicesjp-osa',
                'Region Group': 'jp-osa',   'Cloud Services Group': 'Cloud Services Group'},
            {'label': 'Cloud Services', 'id': 'servicesjp-tok',
                'Region Group': 'jp-tok',   'Cloud Services Group': 'Cloud Services Group'},
            {'label': 'Cloud Services', 'id': 'servicesus-east',
                'Region Group': 'us-east',  'Cloud Services Group': 'Cloud Services Group'},
            {'label': 'Cloud Services', 'id': 'servicesus-south',
                'Region Group': 'us-south', 'Cloud Services Group': 'Cloud Services Group'}
        ]
